...
\begin{frame}{Generate-and-Test Framework}
    ...
    \vspace*{-\baselineskip}
    \begin{myitemize}
        \item \lenitem{A generator program}
        \begin{itemize}
        ...
        \end{itemize} 
        \item \lenitem{Fixing the epistemic atoms of the tester program produces as stable models all the elements of the worldview.}
    \end{myitemize}
